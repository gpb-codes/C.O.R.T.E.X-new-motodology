...
<!-- Logo -->
<code style="font-size: 4.2em; font-weight: 900; letter-spacing: 8px; background: linear-gradient(135deg, #4B167A 0%, #8E44AD 40%, #F2C14E 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; filter: drop-shadow(0 2px 8px rgba(75,22,122,0.15));">C.O.R.T.E.X.</code>

<br>

<span style="font-size: 1.5em; color: #8E44AD; font-weight: 500; letter-spacing: 4px; text-transform: uppercase; border-bottom: 2px solid #F2C14E; padding-bottom: 4px;">New Methodology</span>

<br><br>

<!-- Pilares en línea -->
<p style="font-size: 1.15em; color: #2C2A33; max-width: 700px; margin: 0 auto; line-height: 1.8;">
  <span style="display: inline-block; padding: 2px 10px; background: rgba(75,22,122,0.08); border-radius: 4px;"><strong style="color: #4B167A;">Capturar</strong></span>
  <span style="color: #F2C14E; font-size: 1.2em;">·</span>
  <span style="display: inline-block; padding: 2px 10px; background: rgba(142,68,173,0.08); border-radius: 4px;"><strong style="color: #8E44AD;">Organizar</strong></span>
  <span style="color: #F2C14E; font-size: 1.2em;">·</span>
  <span style="display: inline-block; padding: 2px 10px; background: rgba(75,22,122,0.08); border-radius: 4px;"><strong style="color: #4B167A;">Relacionar</strong></span>
  <span style="color: #F2C14E; font-size: 1.2em;">·</span>
  <span style="display: inline-block; padding: 2px 10px; background: rgba(142,68,173,0.08); border-radius: 4px;"><strong style="color: #8E44AD;">Transformar</strong></span>
  <span style="color: #F2C14E; font-size: 1.2em;">·</span>
  <span style="display: inline-block; padding: 2px 10px; background: rgba(75,22,122,0.08); border-radius: 4px;"><strong style="color: #4B167A;">Evaluar</strong></span>
  <span style="color: #F2C14E; font-size: 1.2em;">·</span>
  <span style="display: inline-block; padding: 2px 10px; background: rgba(142,68,173,0.08); border-radius: 4px;"><strong style="color: #8E44AD;">eXpandir</strong></span>
</p>
...
<div align="center" style="height: 3px; background: linear-gradient(90deg, transparent, #4B167A, #8E44AD, #F2C14E, transparent); width: 80%; margin: 8px auto;"></div>
...
<span style="display: inline-block; padding: 5px 18px; background: linear-gradient(135deg, #4B167A, #6B2C9A); color: white; border-radius: 20px; font-size: 0.75em; font-weight: 600; letter-spacing: 1px; margin: 3px; box-shadow: 0 2px 6px rgba(75,22,122,0.2);">OBSIDIAN VAULT</span>
<span style="display: inline-block; padding: 5px 18px; background: linear-gradient(135deg, #8E44AD, #A569BD); color: white; border-radius: 20px; font-size: 0.75em; font-weight: 600; letter-spacing: 1px; margin: 3px; box-shadow: 0 2px 6px rgba(142,68,173,0.2);">PKM</span>
<span style="display: inline-block; padding: 5px 18px; background: linear-gradient(135deg, #F2C14E, #F4D03F); color: #2C2A33; border-radius: 20px; font-size: 0.75em; font-weight: 600; letter-spacing: 1px; margin: 3px; box-shadow: 0 2px 6px rgba(242,193,78,0.3);">STARTUP</span>
<span style="display: inline-block; padding: 5px 18px; background: linear-gradient(135deg, #2C2A33, #4A4855); color: #FFF1C9; border-radius: 20px; font-size: 0.75em; font-weight: 600; letter-spacing: 1px; margin: 3px; box-shadow: 0 2px 6px rgba(44,42,51,0.2);">A.X.I.S.</span>
<span style="display: inline-block; padding: 5px 18px; background: #FFF1C9; color: #4B167A; border-radius: 20px; font-size: 0.75em; font-weight: 600; letter-spacing: 1px; margin: 3px; border: 1px solid #F2C14E;">CREAR v2</span>
...
<table style="border: none; border-collapse: separate; border-spacing: 4px; background: transparent; width: 100%; max-width: 820px;">
  <tr>
    <td width="16.66%" align="center" style="border: none; border-radius: 10px; padding: 16px 6px; background: linear-gradient(135deg, #4B167A, #6B2C9A); box-shadow: 0 4px 12px rgba(75,22,122,0.25);">
      <div style="color: white; font-weight: 800; font-size: 1.3em;">C</div>
      <div style="color: #F2C14E; font-size: 0.65em; text-transform: uppercase; letter-spacing: 1px; margin-top: 2px;">Capturar</div>
    </td>
    <td width="16.66%" align="center" style="border: none; border-radius: 10px; padding: 16px 6px; background: linear-gradient(135deg, #8E44AD, #A569BD); box-shadow: 0 4px 12px rgba(142,68,173,0.25);">
      <div style="color: white; font-weight: 800; font-size: 1.3em;">O</div>
      <div style="color: #F2C14E; font-size: 0.65em; text-transform: uppercase; letter-spacing: 1px; margin-top: 2px;">Organizar</div>
    </td>
    <td width="16.66%" align="center" style="border: none; border-radius: 10px; padding: 16px 6px; background: linear-gradient(135deg, #4B167A, #6B2C9A); box-shadow: 0 4px 12px rgba(75,22,122,0.25);">
      <div style="color: white; font-weight: 800; font-size: 1.3em;">R</div>
      <div style="color: #F2C14E; font-size: 0.65em; text-transform: uppercase; letter-spacing: 1px; margin-top: 2px;">Relacionar</div>
    </td>
    <td width="16.66%" align="center" style="border: none; border-radius: 10px; padding: 16px 6px; background: linear-gradient(135deg, #8E44AD, #A569BD); box-shadow: 0 4px 12px rgba(142,68,173,0.25);">
      <div style="color: white; font-weight: 800; font-size: 1.3em;">T</div>
      <div style="color: #F2C14E; font-size: 0.65em; text-transform: uppercase; letter-spacing: 1px; margin-top: 2px;">Transformar</div>
    </td>
    <td width="16.66%" align="center" style="border: none; border-radius: 10px; padding: 16px 6px; background: linear-gradient(135deg, #4B167A, #6B2C9A); box-shadow: 0 4px 12px rgba(75,22,122,0.25);">
      <div style="color: white; font-weight: 800; font-size: 1.3em;">E</div>
      <div style="color: #F2C14E; font-size: 0.65em; text-transform: uppercase; letter-spacing: 1px; margin-top: 2px;">Evaluar</div>
    </td>
    <td width="16.66%" align="center" style="border: none; border-radius: 10px; padding: 16px 6px; background: linear-gradient(135deg, #8E44AD, #A569BD); box-shadow: 0 4px 12px rgba(142,68,173,0.25);">
      <div style="color: white; font-weight: 800; font-size: 1.3em;">X</div>
      <div style="color: #F2C14E; font-size: 0.65em; text-transform: uppercase; letter-spacing: 1px; margin-top: 2px;">eXpandir</div>
    </td>
  </tr>
</table>
...
<table style="border: none; border-collapse: separate; border-spacing: 10px; background: transparent; width: 100%; max-width: 780px;">
  <tr>
    ...
    <td align="center" style="border: none; border-radius: 12px; padding: 22px 18px; background: linear-gradient(135deg, rgba(142,68,173,0.08), rgba(142,68,173,0.02)); border: 1px solid rgba(142,68,173,0.15);">
      ...
      <div style="color: #2C2A33; opacity: 0.5; font-size: 0.8em; letter-spacing: 1px;">ESTUDIO</div>
      <div style="margin-top: 6px; font-size: 0.78em; color: #2C2A33; opacity: 0.65;">Cursos, rutas de aprendizaje y repaso espaciado</div>
    </td>
    ...
    <td align="center" style="border: none; border-radius: 12px; padding: 22px 18px; background: linear-gradient(135deg, rgba(44,42,51,0.06), rgba(44,42,51,0.02)); border: 1px solid rgba(44,42,51,0.1);">
      ...
      <div style="color: #2C2A33; opacity: 0.5; font-size: 0.8em; letter-spacing: 1px;">A.X.I.S.</div>
      <div style="margin-top: 6px; font-size: 0.78em; color: #2C2A33; opacity: 0.65;">Memoria persistente del asistente en 3 niveles</div>
    </td>
  </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
  <thead>
...
### Semanal (domingo, 30 min)

<table style="border-collapse: collapse; width: 100%; border-radius: 10px; overflow: hidden; box-shadow: 0 1px 4px rgba(0,0,0,0.06);">
  <thead>
    <tr style="background: linear-gradient(135deg, #4B167A, #8E44AD);">
      <th style="color: white; padding: 8px 14px; border: none; text-align: left; width: 40px;">#</th>
      <th style="color: white; padding: 8px 14px; border: none; text-align: left;">Actividad</th>
      <th style="color: white; padding: 8px 14px; border: none; text-align: center;">Pilar</th>
    </tr>
  </thead>
  <tbody>
...
<table style="border-collapse: collapse; width: 100%; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
  ...
  <tbody>
    <tr style="background: #FFF1C9;"><td style="padding: 6px 16px; border-bottom: 1px solid rgba(44,42,51,0.06);"><strong>Dataview</strong></td><td style="padding: 6px 16px; border-bottom: 1px solid rgba(44,42,51,0.06);">Consultas SQL-like sobre las notas. Motor del dashboard.</td></tr>
...
<table style="border-collapse: collapse; width: 100%; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
  <thead>
    <tr style="background: linear-gradient(135deg, #4B167A, #8E44AD);">
      <th style="color: white; padding: 8px 16px; border: none; text-align: left;">Aspecto</th>
      <th style="color: white; padding: 8px 16px; border: none; text-align: left;">PACE</th>
      <th style="color: white; padding: 8px 16px; border: none; text-align: left;">CORTEX</th>
    </tr>
  </thead>
  <tbody>
...
<table style="border: none; border-collapse: separate; border-spacing: 6px; background: transparent; width: 100%; max-width: 560px;">
  <tr>
    <td align="center" style="border: none; border-radius: 8px; padding: 10px 16px; background: #4B167A; color: white;">
      <strong>00 Inbox</strong><br><span style="font-size: 0.75em; opacity: 0.7;">Capturar</span>
    </td>
    <td align="center" style="border: none; border-radius: 8px; padding: 10px 16px; background: #8E44AD; color: white;">
      <strong>01 Organizar</strong><br><span style="font-size: 0.75em; opacity: 0.7;">Organizar</span>
    </td>
    <td align="center" style="border: none; border-radius: 8px; padding: 10px 16px; background: #4B167A; color: white;">
      <strong>02 MOCs</strong><br><span style="font-size: 0.75em; opacity: 0.7;">Relacionar</span>
    </td>
  </tr>
  <tr>
    <td align="center" style="border: none; border-radius: 8px; padding: 10px 16px; background: #8E44AD; color: white;">
      <strong>03 Transformar</strong><br><span style="font-size: 0.75em; opacity: 0.7;">Transformar</span>
    </td>
    <td align="center" style="border: none; border-radius: 8px; padding: 10px 16px; background: #4B167A; color: white;">
      <strong>04 Evaluar</strong><br><span style="font-size: 0.75em; opacity: 0.7;">Evaluar</span>
    </td>
    <td align="center" style="border: none; border-radius: 8px; padding: 10px 16px; background: #8E44AD; color: white;">
      <strong>05 eXpandir</strong><br><span style="font-size: 0.75em; opacity: 0.7;">eXpandir</span>
    </td>
  </tr>
</table>
